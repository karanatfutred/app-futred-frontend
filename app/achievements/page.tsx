          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <div className="text-2xl font-bold">
                {achievementStats.totalPoints} Points
              </div>
              <div className="text-sm text-muted-foreground">
                Current Rank: {achievementStats.rank}
              </div>
            </div>
            <div className="flex items-center gap-2">
              <Badge className="bg-brand-yellow text-brand-midnight">
                {achievementStats.totalAchievements}/
                {achievementStats.totalAvailable} Achievements
              </Badge>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              ...
              <span>
                ...
                {achievementStats.totalPoints +
                  achievementStats.pointsToNextRank}{" "}
                points
              </span>
            </div>
            <Progress
            ...
            <div className="text-xs text-muted-foreground">
              Earn {achievementStats.pointsToNextRank} more points to reach{" "}
              {achievementStats.nextRank} rank
            </div>
          </div>
        </CardContent>
      </Card>
              ...
              >
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <div className="bg-brand-yellow/10 rounded-full p-2 flex-shrink-0 mt-1">
                      {achievement.icon}
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {achievement.isNew && (
                          <Badge className="bg-brand-yellow/10 text-brand-yellow">
                            New
                          </Badge>
                        )}
                      </div>
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        <div className="text-sm font-medium text-brand-yellow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {inProgressAchievements.map((achievement) => (
              ...
              >
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <div className="bg-brand-skyblue/10 rounded-full p-2 flex-shrink-0 mt-1">
                      {achievement.icon}
                    </div>
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        <div className="text-sm font-medium text-brand-skyblue">
                          +{achievement.points} pts
                        </div>
                      </div>
                    </div>
        ...
        <TabsContent value="all" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card className="text-center p-6 hover:shadow-md transition-all">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Demonstrate technical skills and coding proficiency
              </p>
              <Badge className="bg-brand-skyblue/10 text-brand-skyblue">
                1 of 6 Earned
              </Badge>
            ...
            <Card className="text-center p-6 hover:shadow-md transition-all">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Work effectively with your team and peers
              </p>
              <Badge className="bg-brand-skyblue/10 text-brand-skyblue">
                2 of 10 Earned
              </Badge>
